    ...
    module Template
      ...
      module Rghost
        ...
        def modelo_generico_rodape(doc, boleto)
          ...
          doc.text 'remessa dos autos à Procuradoria Geral do Estado para <bold>inscrição em dívida ativa, registro nos órgãos de proteção</bold>'          
          doc.moveto :x => '0.5 cm' , :y => '9.9 cm'
          doc.text '<bold> ao crédito e ajuizamento de execução fiscal </bold> (art. 6º, inciso VI, IN 001/2015 – HEMOPI).'

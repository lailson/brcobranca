    ...
    module Template
      ...
      module Rghost
        ...
        def modelo_generico_rodape(doc, boleto)
          ...
          doc.text '<bold> - Não receber após 60 dias do vencimento.</bold>'
          doc.moveto :x => '0.5 cm' , :y => '11.1 cm'
          doc.text '<bold>Não serão processados ou contabilizados os pagamentos realizados via depósito ou transferência bancária.</bold>(art. 5º, II, IN 001/2015 HEMOPI)'
          ...
          doc.text 'administrativo e remessa dos autos à Procuradoria Geral do Estado para  <bold>inscrição em dívida ativa do Estado, </bold>'          
          doc.moveto :x => '0.5 cm' , :y => '9.9 cm'
          doc.text '<bold>registro nos órgãos de proteção ao crédito e ajuizamento de execução fiscal</bold> (art. 5º, inciso II,§3º, IN 001/2015'
